...
namespace domain {
    ...
    Customer::Customer(string id, string name, vector<string> reserved_scooters) : id(id), name(name),
                                                                                   reserved_scooters(
                                                                                           reserved_scooters) {}
    ...
    vector<string> Customer::get_reserved_scooters() {
    ...
    bool Customer::has_scooter(string id) {
        for (int i = 0; i < reserved_scooters.size(); i++) {
            if (id == reserved_scooters[i]) return true;
        }
        return false;
    }
};